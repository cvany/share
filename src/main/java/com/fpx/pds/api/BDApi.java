...
//
//        List<PickupPoint> listPoint = JSON.parseArray(json, PickupPoint.class);
//        if (null != listPoint && listPoint.size() != 0) {
//            lngList = new ArrayList<>();
//            latList = new ArrayList<>();
//            for (PickupPoint p : listPoint) {
//                lngList.add(p.getLng());
//                latList.add(p.getLat());
//            }
//        }
//        Double[] lons = lngList.toArray(new Double[lngList.size()]);
//        Double[] lats = latList.toArray(new Double[latList.size()]);
//        // 将区域各顶点的横纵坐标放到一个点集合里面
//        List<Point2D.Double> pointList = new ArrayList<Point2D.Double>();
//        double polygonPoint_x = 0.0, polygonPoint_y = 0.0;
//        for (int i = 0; i < lons.length; i++) {
//            polygonPoint_x = lons[i];
//            polygonPoint_y = lats[i];
